...
```{r}
homerun_0_outs_0_runners = 0 #State 1 -> 1
homerun_1_outs_0_runners = 0 #State 9 -> 9
homerun_2_outs_0_runners = 0 #State 17 -> 17

homerun_0_outs_runner_1 = 0 #State 2 -> 1
homerun_1_outs_runner_1 = 0 #State 10 -> 9
homerun_2_outs_runner_1 = 0 #State 18 ->17 

homerun_0_outs_runner_2 = 0 #State 3 -> 1
homerun_1_outs_runner_2 = 0 #State 11 -> 9
homerun_2_outs_runner_2 = 0 #State 19 -> 17

homerun_0_outs_runner_3 = 0 #State 4 -> 4
homerun_1_outs_runner_3 = 0 #State 12 -> 9
homerun_2_outs_runner_3 = 0 #State 20 -> 17

homerun_0_outs_runner_12 = 0 #State 5 -> 1
homerun_1_outs_runner_12 = 0 #State 13 -> 9
homerun_2_outs_runner_12 = 0 #State 21 -> 17

homerun_0_outs_runner_13 = 0 #State 6 -> 1
homerun_1_outs_runner_13 = 0 #State 14 -> 9
homerun_2_outs_runner_13 = 0 #State 22 -> 17

homerun_0_outs_runner_23 = 0 #State 7 -> 1
homerun_1_outs_runner_23 = 0 #State 15 -> 9
homerun_2_outs_runner_23 = 0 #State 23 -> 17

homerun_0_outs_3_runners = 0 #State 8 -> 1
homerun_1_outs_3_runners = 0 #State 16 -> 9
homerun_2_outs_3_runners = 0 #State 24 -> 17
```

Setup Variables For Single/Walk 
```{r}

single_0_outs_0_runners = 0 #State 1 -> 2
single_1_outs_0_runners = 0 #State 9 -> 10
single_2_outs_0_runners = 0 #State 17 -> 18

single_0_outs_runner_1 = 0 #State 2 -> 1
single_1_outs_runner_1 = 0 #State 10 -> 9
single_2_outs_runner_1 = 0 #State 18 ->17 

```


Single For 0 Outs, 1 Out, and 2 Outs
```{r}
for (i in 1:nrow(dodgers_2023)) {
  # No Runners On Base
  if (dodgers_2023$outs[i] == 0 && dodgers_2023$event_type[i] == 20
      && dodgers_2023$first_runner[i] == ''
      && dodgers_2023$second_runner[i] == ''
      && dodgers_2023$third_runner[i] == '') {
    single_0_outs_0_runners <- single_0_outs_0_runners + 1
  }
  if (dodgers_2023$outs[i] == 1 && dodgers_2023$event_type[i] == 20
      && dodgers_2023$first_runner[i] == ''
      && dodgers_2023$second_runner[i] == ''
      && dodgers_2023$third_runner[i] == '') {
    single_1_outs_0_runners <- single_1_outs_0_runners + 1
  }
  if (dodgers_2023$outs[i] == 2 && dodgers_2023$event_type[i] == 20
      && dodgers_2023$first_runner[i] == ""
      && dodgers_2023$second_runner[i] == ""
      && dodgers_2023$third_runner[i] == "") {
    single_2_outs_0_runners <- single_2_outs_0_runners + 1
  }
