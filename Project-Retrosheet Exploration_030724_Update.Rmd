...
for (i in 1:nrow(dodgers_2023)) {
  ...
  if (dodgers_2023$second_runner[i] != '') {
    num_runners <- num_runners + 1
  }
  if (dodgers_2023$third_runner[i] != '') {
    num_runners <- num_runners + 1
  }
  ...
  # 1 Runner On Base - Essentially a Homerun with 1 Runner on Base
  if (dodgers_2023$outs[i] == 0 && dodgers_2023$event_type[i] == 23
      && num_runners == 1) {
    homerun_0_outs_1_runners <- homerun_0_outs_1_runners + 1
  }
  
  if (dodgers_2023$outs[i] == 1 && dodgers_2023$event_type[i] == 23
      && num_runners == 1) {
    homerun_1_outs_1_runners <- homerun_1_outs_1_runners + 1
  }
  
  if (dodgers_2023$outs[i] == 2 && dodgers_2023$event_type[i] == 23
      && num_runners == 1) {
    homerun_2_outs_1_runners <- homerun_2_outs_1_runners + 1
  }
  
  # 2 Runners on Base - Essentially a Homerun with 2 Runners on Base
  if (dodgers_2023$outs[i] == 0 &&
      dodgers_2023$event_type[i] == 23
      && num_runners == 2) {
    homerun_0_outs_2_runners <- homerun_0_outs_2_runners + 1
  }
  
  if (dodgers_2023$outs[i] == 1 && dodgers_2023$event_type[i] == 23
      && num_runners == 2) {
    homerun_1_outs_2_runners <- homerun_1_outs_2_runners + 1
  }
  
  if (dodgers_2023$outs[i] == 2 && dodgers_2023$event_type[i] == 23
      && num_runners == 2) {
    homerun_2_outs_2_runners <- homerun_2_outs_2_runners + 1
  }
